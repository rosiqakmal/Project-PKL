...
if(isset($_POST['simpan'])){
	...
	$update = mysql_query("UPDATE siswa SET siswa_nis='$nis', siswa_nama='$nama', siswa_kelas='$kelas', siswa_jurusan='$jurusan', tanggal_pendaftaran='$tglap' WHERE siswa_id='$id'") or die(mysql_error());
